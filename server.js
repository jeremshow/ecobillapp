...
app.use(express.static(__dirname)); // Permet de servir les fichiers statiques dans le répertoire racine
...
app.get('/signup.html', (req, res) => {
    res.sendFile(__dirname + '/signup.html'); // Assurez-vous d'avoir le bon chemin vers signup.html
});
...
// Démarrer le serveur
const PORT = process.env.PORT || 5492; // Utilise le port spécifié dans les variables d'environnement ou 5492 par défaut
app.listen(PORT, () => {
