...
const path = require('path'); // Ajout de path pour gérer les fichiers
...
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'index.html')); // Assure-toi d'avoir un fichier index.html
});
